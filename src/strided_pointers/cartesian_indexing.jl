...
@inline tdot(::Type{T}, a::Tuple{A}, b::Tuple{B,Vararg}, ::Tuple{Val{false},Vararg}) where {T,A,B} = lazymul(first(a), first(b))
...
@inline tdot(::Type{T}, a::Tuple{A}, b::Tuple{B,Vararg}, c::Tuple{C,Vararg}, ::Tuple{Val{false},Vararg}) where {T,A,B,C} = lazymul(first(a), first(b))
@inline tdot(::Type{T}, a::Tuple{A}, b::Tuple{B,Vararg}, c::Tuple{C,Vararg}, ::Tuple{Val{true},Vararg}) where {T,A,B,C} = lazymul_no_promote(T,first(a), first(b))
