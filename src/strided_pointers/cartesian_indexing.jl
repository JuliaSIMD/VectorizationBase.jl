...
@inline tdot(a::Tuple{A1,A2,Vararg}, b::Tuple{B1,B2,Vararg}, c::Tuple{Val{false},Vararg}) where {A1,A2,B1,B2} = vadd(lazymul(first(a), first(b)), tdot(Base.tail(a), Base.tail(b), Base.tail(c)))
@inline tdot(a::Tuple{A1,A2,Vararg}, b::Tuple{B1,B2,Vararg}, c::Tuple{Val{true},Vararg}) where {A1,A2,B1,B2} = vadd(lazymul_no_promote(first(a), first(b)), tdot(Base.tail(a), Base.tail(b), Base.tail(c)))
...
@inline function tdot(a::Tuple{A1,A2,Vararg}, b::Tuple{B1,B2,Vararg}, c::Tuple{C1,C2,Vararg}, d::Tuple{Val{false},Vararg}) where {A1,A2,B1,B2,C1,C2}
    vadd(lazymul(first(a), first(b), first(c)), tdot(Base.tail(a), Base.tail(b), Base.tail(c), Base.tail(d)))
end
@inline function tdot(a::Tuple{A1,A2,Vararg}, b::Tuple{B1,B2,Vararg}, c::Tuple{C1,C2,Vararg}, d::Tuple{Val{true},Vararg}) where {A1,A2,B1,B2,C1,C2}
    vadd(lazymul_no_promote(first(a), first(b), first(c)), tdot(Base.tail(a), Base.tail(b), Base.tail(c), Base.tail(d)))
end
