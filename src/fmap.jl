...
@inline ifelse(v1::Vec{W,Bool}, v2::VecUnroll{N,W,T}, v3::AbstractSIMDVector) where {N,W,T} = VecUnroll(fmap(ifelse, Vec{W,T}(v1), v2.data, Vec{W,T}(v3)))
@inline ifelse(v1::Vec{W,Bool}, v2::AbstractSIMDVector, v3::VecUnroll{N,W,T}) where {N,W,T} = VecUnroll(fmap(ifelse, Vec{W,T}(v1), Vec{W,T}(v2), v3.data))
@inline ifelse(v1::VecUnroll{N,W,Bool}, v2::VecUnroll{N,W,T}, v3::AbstractSIMDVector) where {N,W,T} = VecUnroll(fmap(ifelse, v1.data, v2.data, Vec{W,T}(v3)))
@inline ifelse(v1::VecUnroll{N,W,Bool}, v2::AbstractSIMDVector, v3::VecUnroll{N,W,T}) where {N,W,T} = VecUnroll(fmap(ifelse, v1.data, Vec{W,T}(v2), v3.data))
